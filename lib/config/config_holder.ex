defmodule MsEvaluateRules.Config.ConfigHolder do
  use GenServer
  alias MsEvaluateRules.Config.AppConfig
  @table_name :ms_evaluate_rules_config
  ...
  defp load_additional_properties(%AppConfig{} = config) do
    Application.get_env(:ms_evaluate_rules, :config_loaders, [])
...
defmodule MsEvaluateRules.Config.ConfigHolder.PropertiesLoaderBehaviour do
  alias MsEvaluateRules.Config.AppConfig
