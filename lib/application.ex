defmodule MsEvaluateRules.Application do
  @moduledoc """
  MsEvaluateRules application
  """

  alias MsEvaluateRules.Infrastructure.EntryPoint.ApiRest
  alias MsEvaluateRules.Config.{AppConfig, ConfigHolder}
  ...
  def start(_type, [env]) do
    ...
    opts = [strategy: :one_for_one, name: MsEvaluateRules.Supervisor]
