defmodule MsEvaluateRules.Utils.CustomTelemetryTest do
  alias MsEvaluateRules.Utils.CustomTelemetry
  use ExUnit.Case
  ...
  test "execute_custom_event emits the event with correct metric, value, and metadata" do
    ...
    value = 200
    metadata = %{source: "api"}
    service_name = "ms_evaluate_rules_test"
  ...
  test "handle_custom_event adds service name to metadata" do
    ...
    Application.put_env(:ms_evaluate_rules, :service_name, service_name)
  ...
  test "execute_custom_event emits the correct event with default metadata" do
    metric = [:custom, :event]
    value = 200
    expected_metadata = %{service: "ms_evaluate_rules_test"}
